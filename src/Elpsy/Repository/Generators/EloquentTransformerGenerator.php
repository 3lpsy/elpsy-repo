...
use Elpsy\Repository\Generators\TransformerGenerator;
use Elpsy\Repository\Generators\ModelGenerator;

/**
 * Class TransformerGenerator
 * @package Elpsy\Repository\Generators
 */
class EloquentTransformerGenerator extends TransfomerGenerator
{
    /**
     * Get stub name.
     *
